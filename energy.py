...
input_file = './dataJ=0.1_U=0.01-18_100.dat'  # Replace 'input.csv' with the path to your input file
output_file = './dataJ=0.1_U=0.01-18_100_energy.dat'  # Replace 'output.csv' with the path to your output file
